...
INSERT INTO `log` VALUES (21,'3468935316','火花','吃饭+厕所','2018-04-02 19:01:33','2018-04-02 19:01:36',0,0,'500wn'),(22,'3468935316','火花','抽烟','2018-04-02 19:03:06','2018-04-02 19:05:54',3,0,'500wn'),(25,'3468935316','火花','吃饭','2018-04-02 22:35:15',NULL,NULL,NULL,'500wn'),(27,'id101','大润发','吃饭','2018-04-02 22:48:26','2018-04-02 22:48:28',0,0,'500wn'),(28,'id101','大润发','抽烟','2018-04-02 22:48:29','2018-04-02 22:48:30',0,0,'500wn');
...
CREATE TABLE `setting` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=10 DEFAULT CHARSET=utf8 COMMENT='网站其他设置';
...
CREATE TABLE `stuff` (
  ...
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=321 DEFAULT CHARSET=utf8 COMMENT='员工信息';
...
CREATE TABLE `time` (
  ...
  `company` varchar(255) DEFAULT NULL COMMENT '所属公司',
  PRIMARY KEY (`Id`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='每日用时记录';
...
INSERT INTO `time` VALUES (1,'火花','3468935316',82,18,'2018-04-02',0,'500'),(2,'火花','3468935316',3,2,'2018-04-02',0,'500wn'),(4,'大润发','id101',0,2,'2018-04-02',0,'500wn');
